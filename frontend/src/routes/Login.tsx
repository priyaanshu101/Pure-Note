        ...
        <div className="h-screen pt-40 pb-20 px-6 text-center relative z-10 bg-[linear-gradient(to_right,_#9ca3af,_#f1f2f4,_#9ca3af)]">
          <div className="flex flex-col justify-center items-center max-w-3xl mx-auto backdrop-blur-2xl bg-white/60 p-10 rounded-3xl shadow-xl border border-primary-200 relative z-10">
            ...
            <div className="flex justify-center items-center">
                <button 
                onClick={handleClick}
                className="w-80 h-[50px] bg-primary-800 text-white font-semibold text-xl hover:bg-primary-900 shadow-lg hover:scale-105 transition-all duration-300 ease-out will-change-transform px-4 py-2 rounded-xl">Login</button>
            </div>

            <div className="pt-6 text-gray-500">
                Don't have an account?{" "}<span className="text-gray-900 font-semibold"><Link to='/signup'>Create one here</Link></span>
                <div className="text-gray-900 pt-2 font-semibold"><Link to='/forgotPass'>Forgot Password?</Link></div>
            </div>
          </div>
        </div>
      </div>
