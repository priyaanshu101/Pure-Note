...
export function Sidebar({ specificContent }: { specificContent: (title: string) => void }) {
  return (
    <div className="flex flex-col justify-between h-screen w-60 bg-white border-r-2 fixed left-0 top-0 shadow-lg">
...
function Option({ icon, title, onClick }) {
  return (
    <div
      className="flex items-center pl-4 py-2 gap-3 cursor-pointer hover:bg-[#faf7fe] mx-5 rounded-md transition-all duration-200"
